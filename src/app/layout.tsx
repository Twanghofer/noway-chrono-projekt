    ...
    <TrackingProvider>
      <html lang="de">
        ...
        >
          ...
          <footer className="text-sm text-center flex items-center justify-center gap-2">
            <div>
              Made with <span className="align-middle">❤️</span> by{" "}
              <Link
            ...
            <Link
              ...
              href="https://github.com/Twanghofer/noway-chrono-projekt"
              target="_blank"
            >
              <svg
                width="20"
